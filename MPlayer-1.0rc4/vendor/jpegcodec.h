...
#ifndef __ASM_ARM_W55FA95_JPEG_H
#define __ASM_ARM_W55FA95_JPEG_H
...
typedef struct
{
	...
	FILE						*dfile_handle;
	FILE						*efile_handle;
	unsigned char				*in_jpeg_buff;
	unsigned int				in_jpeg_buff_size;
	int 						quality;
	int							is_encode_to_mem;
	int							is_read_jpeg_from_mem;
	int							out_jpeg_size;
	unsigned char				*out_jpeg_buff;
	int							out_raw_size;
	unsigned char				*out_raw_buff;
	int							row_stride;
	unsigned char				*temp_dptr;
	unsigned char				*temp_eptr;
	unsigned int				offset;
	int							isHWEnabled;
	unsigned int				total_jpeg_buffer_size;
