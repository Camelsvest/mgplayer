...
av_cold int ff_h263_decode_init(AVCodecContext *avctx)
{
	...
	if ( s->width == 0 ) s_flag = 0;
	else s_flag = 1;

	av_log( avctx, AV_LOG_INFO, "### ff_h263_decode_init, s->width = %d, s->height = %d ###\n", s->width, s->height );
    ...
    case CODEC_ID_H263:
		...
		av_log( avctx, AV_LOG_INFO, "### CODEC_ID_H263 ###\n" );
        break;
    case CODEC_ID_MPEG4:
		av_log( avctx, AV_LOG_INFO, "### CODEC_ID_MPEG4 ###\n" );
        break;
    ...
    case CODEC_ID_FLV1:
        s->h263_flv = 1;
		av_log( avctx, AV_LOG_INFO, "### CODEC_ID_FLV1 ###\n" );
        break;
    default:
        return -1;
    }
	...
	av_log( avctx, AV_LOG_INFO, "### ff_h263_decode_init done ###\n" );
...
av_cold int ff_h263_decode_end(AVCodecContext *avctx)
{
	...
	av_log( avctx, AV_LOG_INFO, "### ff_h263_decode_end ###\n" );
...
///	av_log( avctx, AV_LOG_INFO, "### ff_h263_decode_frame ###\n" );
...
///		d = g_vpe.center + fb_line_len * y + fb_pixel_size * x;
		g_vpe.PAT_WIDTH = s->width;
		g_vpe.PAT_HEIGHT = s->height;
		g_vpe.total_x = s->width;
		g_vpe.total_y = s->height;
