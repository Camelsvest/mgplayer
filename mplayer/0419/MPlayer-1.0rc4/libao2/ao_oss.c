...
///  }
	...
	{
		mp_msg(MSGT_AO,MSGL_ERR,MSGTR_AO_OSS_CantOpenDev, dsp, strerror(errno));
		mp_msg(MSGT_AO,MSGL_INFO,"### init - open /dev/dsp failed! Try to open /dev/dsp2! ###\n");
		audio_fd = open( "/dev/dsp2", O_WRONLY | O_NONBLOCK );
		if ( audio_fd < 0 )
		{
			mp_msg(MSGT_AO,MSGL_ERR,MSGTR_AO_OSS_CantOpenDev, dsp, strerror(errno));
			mp_msg(MSGT_AO,MSGL_INFO,"### init - open /dev/dsp2 failed! ###\n");
			return 0;
		}
	}
...
///    }
	...
	{
		mp_msg(MSGT_AO,MSGL_ERR,MSGTR_AO_OSS_CantReopen, strerror(errno));
		mp_msg(MSGT_AO,MSGL_INFO,"### reset - open /dev/dsp failed! Try to open /dev/dsp2! ###\n");
		audio_fd = open( "/dev/dsp2", O_WRONLY );
		if ( audio_fd < 0 )
		{
			mp_msg(MSGT_AO,MSGL_ERR,MSGTR_AO_OSS_CantReopen, strerror(errno));
			mp_msg(MSGT_AO,MSGL_INFO,"### reset - open /dev/dsp2 failed! ###\n");
			return;
		}
	}
