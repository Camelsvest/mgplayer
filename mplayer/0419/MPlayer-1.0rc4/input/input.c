...
extern int demo_msgq_index;
extern char * demo_msgq_cmd;
#endif
...
static const mp_cmd_t mp_cmds[] = {
  ...
  { MP_CMD_VENDOR_OSD, "vendor_osd",0, { {MP_CMD_ARG_INT,{-1}}, {-1,{0}} } },
  { MP_CMD_GET_VENDOR_STATE, "get_vendor_state", 0, { {-1,{0}} } },
  { MP_CMD_VENDOR_SCALE, "vendor_scale",0, { {MP_CMD_ARG_INT,{-1}}, {-1,{0}} } },
  { MP_CMD_VENDOR_ROTATE, "vendor_rotate",0, { {MP_CMD_ARG_INT,{-1}}, {-1,{0}} } },
  { MP_CMD_VENDOR_DX, "vendor_dx",0, { {MP_CMD_ARG_INT,{-1}}, {-1,{0}} } },
  { MP_CMD_VENDOR_DY, "vendor_dy",0, { {MP_CMD_ARG_INT,{-1}}, {-1,{0}} } },
#endif
...
static mp_cmd_t *read_events(int time, int paused)
{
	...
	{
		mp_msg(MSGT_INPUT,MSGL_INFO,"### MPLAYER_CMD = %s ###\n", demo_msgq_cmd);
		mp_cmd_t *ret = mp_input_parse_cmd(demo_msgq_cmd);
		mp_msg(MSGT_INPUT,MSGL_INFO,"### excute cmd = success! ###\n");
		demo_msgq_SendMsg( "### excute cmd success! ###" );
